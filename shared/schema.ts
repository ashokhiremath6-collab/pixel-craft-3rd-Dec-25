...
export const activityLog = pgTable("activity_log", {
  ...
  activityType: text("activity_type").notNull(), // floor_plan, moodboard, quote_file, boq_file, schedule, working_drawing, render, vendor_create, vendor_update, vendor_delete
  fileName: text("file_name").notNull(),
...
export const insertActivityLogSchema = createInsertSchema(activityLog).omit({
  ...
  activityType: z.enum(["floor_plan", "moodboard", "quote_file", "boq_file", "schedule", "working_drawing", "render", "vendor_create", "vendor_update", "vendor_delete"]),
});
