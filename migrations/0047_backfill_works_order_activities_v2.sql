-- Second-pass backfill: catches works orders that were created after
-- migration 0046 ran (timing gap between deploy and user uploads)
-- or any others still missing an activity_log entry.
-- The WHERE NOT EXISTS guard makes this fully idempotent.
