# Execution SOPs for Interior Design Projects

These SOPs are written to be handed to vendors and contractors. They specify what an experienced interior designer demands beyond what any half-decent contractor already knows. The intent is to make the difference between a 7/10 job and a 9/10 job non-negotiable.

Each SOP follows the same structure:
- **Purpose** — what this SOP exists to prevent
- **System acceptability** — what materials/brands are acceptable, what are downgrades, what is forbidden
- **Pre-conditions** — what must be true before work begins
- **Procedure** — step-by-step method
- **Things vendors skip if not watched** — the specific corners that get cut, with required evidence
- **Inspection points** — what to test, when, and what failure looks like
- **Acceptance criteria** — handover standard
- **Do NOT** — non-negotiable prohibitions

---

# TIER 1 — DEEP SOPs

## SOP 1 — PU (Polyurethane) Polish Application

**Purpose:** Achieve a furniture-grade PU finish that retains clarity, sheen, and adhesion for 7+ years in Indian residential conditions. PU is the most-failed finish in Indian interior work — typically through use of inferior products, inadequate cure time, or wrong sheen consistency between panels.
...
- Lay veneer over unsanded filler patches or visible substrate defects

---

## SOP 3 — Wall Surface Preparation Before Painting
...
- Accept "we'll test after the tiles are down" — this is the most common excuse for waterproofing failure

---

## SOP 5 — Marble & Natural Stone Installation

**Purpose:** Install marble, granite, or other natural stone with full bedding, no staining, and a polished finish that lasts decades. Stone installation defects (yellowing, picture-framing, hollow spots, polish failure) are extremely expensive to correct because the stone must be lifted, the bedding reworked, and the stone re-laid — often with damage to the stone.
...
- Leave the DB unlabeled

---

## SOP 7 — Air Conditioning Indoor Unit Installation

**Purpose:** Install split or VRF AC indoor units securely, with proper drainage, refrigerant pipe routing, electrical safety, and acoustic isolation. AC installation defects cause drainage leaks (water damage to walls and ceilings), refrigerant leaks (cooling failure, environmental issue), excessive noise, and electrical hazards.
...
- Accept "I'll come back and check the cooling after a week" — commissioning must be complete at the time of installation

---

## SOP 8 — Sanitary Fixture Installation

**Purpose:** Install sanitary fixtures level, properly sealed, and leak-tested with attention to long-term water integrity. Sanitary installation defects (slow leaks at concealed pipe joints, failed wax seals on WCs, water damage from improperly sealed fixtures) cause progressive water damage that may not be visible for months but compromises the entire bathroom.
...
- Tile or finish the surrounding wall before water test passes

---

## SOP 10 — Sofa & Upholstery Manufacturing Standards

**Purpose:** Ensure custom-manufactured sofas, armchairs, and upholstered furniture meet the structural, comfort, and durability standards expected of premium interior design work. Upholstery failures (sagging cushions, frame creaking, fabric loosening, foam collapse) become apparent within 6-18 months and are the most common cause of client complaints in custom furniture work.
...
# TIER 2 — MEDIUM-DEPTH SOPs

## SOP 11 — Plywood Selection & Grading

**Purpose:** Ensure correct plywood grade is used for each application, preventing warping, delamination, or moisture failure. Plywood substitution (lower grade than specified) is one of the most common cost-cutting tricks by vendors and is invisible until failure occurs.
...
- Skip edge sealing on cut edges

---

## SOP 12 — Cabinet Carcass Construction

**Purpose:** Build cabinet structures that hold square, support specified loads, and remain rigid for decades.
...
- Skip back panel grooving (causes racking)

---

## SOP 13 — Melamine Polish Application

**Purpose:** Apply melamine finish to indoor furniture in dry areas with proper sealer base and adequate top-coat protection.
...
## SOP 14 — Veneer Polish Finishing

**Purpose:** Finish veneer to specified open-pore or close-pore appearance, preserving grain visibility while providing surface protection.
...
- Mix open-pore and close-pore on the same piece without drawing instruction

---

## SOP 15 — Emulsion Paint Application
...
- Paint with windows open if humidity is over 80% (paint won't cure properly)

---

## SOP 16 — Enamel Paint on Wood & Metal

**Purpose:** Apply enamel finish to wood trim, doors, frames, and metal surfaces with proper preparation and durable coverage.
...
- Skip intermediate sanding
- Paint over rust without proper removal

---

## SOP 17 — Plaster of Paris False Ceiling

**Purpose:** Construct a flat, crack-free POP false ceiling that holds level and accepts paint finish, with no visible joints or cracks.
...
- Skip access panels at locations where concealed services will need future maintenance

---

## SOP 18 — Floor Tile Laying

**Purpose:** Lay floor tiles level, with consistent joints, full mortar bedding, and clean grouting that will not develop hollow spots, edge chipping, or grout failure.
...
- Use cement-sand bedding alone for ceramic/porcelain (causes cracking)

---

## SOP 19 — CPVC Pipe Installation

**Purpose:** Install hot and cold water supply pipes with proper joints, supports, and pressure testing for decades of leak-free service.
...
- Use UPVC for hot water lines

---

## SOP 20 — Toughened Glass Installation

**Purpose:** Install toughened glass safely, with proper edge protection, setting blocks, and secure fixing that doesn't fail catastrophically.
...
- Skip safety markings on walking-zone panels

---

## SOP 21 — Drawing Issue & Revision Control

**Purpose:** Ensure vendors and site teams always work from the current approved drawing. Drawing-version mistakes cause expensive rework when work is done to an outdated drawing.
...
## SOP 22 — Switch & Socket Installation

**Purpose:** Install switches and sockets at standard heights, aligned, tested, and free from electrical defects.
...
- Install before walls are dry and clean

---

## SOP 23 — Curtain & Drape Installation

**Purpose:** Install curtain tracks/rods and drapes with proper drop, stack-back, and operating smoothness.
...
- Install on uncured wall paint (24 hours minimum)

---

## SOP 24 — Site Cleanliness & Safety

**Purpose:** Maintain a clean, safe site that supports good workmanship, protects existing finishes from damage, and prevents accidents.
...
- Leave site without locking and securing

---

## SOP 25 — Project Handover

**Purpose:** Close out a project formally with all documentation, snags closed, and warranties transferred to the client.
...
Editable by your daughter to reflect her firm's brand preferences, regional supplier networks, and accumulated experience.
