...
const USER_ID = '68c68b90-7b0c-4878-95b4-c1e25c2d12b9';
const ORG_ID  = '74195e4d-0c47-4413-af59-793218e45c74';

const SOPS: { category: string; title: string; description: string; content: string }[] = [
  {
    category: 'Carpentry & Joinery',
    title: 'Plywood Selection & Grading',
    description: 'Ensure correct plywood grade is used for each application, avoiding warping, delamination, or moisture failure.',
    content: `PURPOSE: Ensure correct plywood grade is used for the application, avoiding warping, delamination, or moisture failure.
...
DO NOT: Use MR grade in wet areas. Substitute lower grades without written approval. Use sheets stored on a wet floor. Mix grades within a single piece of furniture.`,
  ...
  {
    category: 'Carpentry & Joinery',
    title: 'Veneer Application on Plywood',
    description: 'Achieve a flat, bubble-free veneer surface with proper grain alignment and edge integrity.',
    content: `PURPOSE: Achieve a flat, bubble-free veneer surface with proper grain alignment and edge integrity.
...
DO NOT: Apply veneer to damp substrate. Use expired adhesive. Stack panels before adhesive has cured. Sand veneer face before 24-hour cure.`,
  ...
  {
    category: 'Carpentry & Joinery',
    title: 'Cabinet Carcass Construction',
    description: 'Build cabinet structures that hold square, support specified loads, and remain rigid over time.',
    content: `PURPOSE: Build cabinet structures that hold square, support specified loads, and remain rigid over time.
...
- Fasteners: [approved brand], confirmat screws or equivalent for joinery
...
5. Adjustable shelves on shelf pins minimum two per side per shelf. Fixed shelves dado'd into sides.
...
DO NOT: Use nails alone for structural joints. Substitute hardware brands without approval. Skip pre-drilling. Apply finish to unsquare carcass.`,
  ...
  {
    category: 'Polishing & Finishing',
    title: 'PU Polish (Polyurethane) Application',
    description: 'Apply a durable, even PU finish at the specified sheen with no visible application marks.',
    content: `PURPOSE: Apply a durable, even PU finish at the specified sheen with no visible application marks.
...
DO NOT: Apply PU in dusty conditions. Mix different brands of PU. Skip intermediate sanding. Handle work before 24-hour dry. Apply over uncured stain or sealer.`,
  ...
  {
    category: 'Polishing & Finishing',
    title: 'Melamine Polish Application',
    description: 'Apply melamine finish to indoor furniture with proper sealer base and adequate top-coat protection.',
    content: `PURPOSE: Apply melamine finish to indoor furniture with proper sealer base and adequate top-coat protection.
...
NOTE: Melamine is suitable for indoor furniture in dry areas only. For wardrobes adjacent to bathrooms, kitchen, or outdoor application, use PU instead.`,
  ...
  {
    category: 'Polishing & Finishing',
    title: 'Veneer Polish Finishing',
    description: 'Finish veneer to the specified open-pore or close-pore finish, preserving grain visibility while providing surface protection.',
    content: `PURPOSE: Finish veneer to the specified open-pore or close-pore finish, preserving grain visibility while providing surface protection.
...
DO NOT: Sand through veneer face. Apply heavy coats that obscure grain. Use staining brand not approved by client. Mix open-pore and close-pore on the same piece without drawing instruction.`,
  },
  {
    category: 'Painting',
    title: 'Wall Surface Preparation Before Painting',
    description: 'Prepare wall surfaces so the paint system bonds, covers evenly, and lasts without flaking, blistering, or color variation.',
    content: `PURPOSE: Prepare wall surfaces so the paint system bonds, covers evenly, and lasts without flaking, blistering, or color variation.
...
DO NOT: Paint on moist walls. Skip putty coats on uneven walls. Use putty as a substitute for plaster repair. Skip primer.`,
  },
  {
    ...
    content: `PURPOSE: Apply interior emulsion paint to achieve uniform color, sheen, and coverage with no application marks.
...
MATERIALS:
- Emulsion paint: [approved brand and product line per project spec — Premium / Royale / Apex / equivalent]
...
DO NOT: Recoat before previous coat is dry. Mix different brands or batches without boxing. Apply in direct sunlight on exterior walls. Skip the second coat regardless of how good the first coat looks.`,
  ...
  {
    category: 'Painting',
    title: 'Enamel Paint on Wood & Metal',
    description: 'Apply enamel finish to wood and metal substrates with proper preparation and durable coverage.',
    content: `PURPOSE: Apply enamel finish to wood and metal substrates with proper preparation and durable coverage.
...
DO NOT: Apply enamel without primer. Use water-based enamel on rust-prone metal without rust-converting primer. Skip intermediate sanding.`,
  },
  {
    ...
    title: 'Plaster of Paris (POP) False Ceiling',
    description: 'Construct a flat, crack-free POP false ceiling that holds level and accepts paint finish.',
    content: `PURPOSE: Construct a flat, crack-free POP false ceiling that holds level and accepts paint finish.
...
MATERIALS:
- Framework: GI channels [section per drawing], hangers, perimeter angle
...
DO NOT: Hang heavy fixtures from POP — use independent fixing through framework to slab. Apply POP over wet substrate. Skip jointing compound treatment. Paint before POP is fully dry (minimum 7 days).`,
  },
  {
    ...
    description: 'Apply waterproofing system that prevents water penetration through bathroom and balcony floors and walls.',
    content: `PURPOSE: Apply waterproofing system that prevents water penetration through bathroom and balcony floors and walls.
...
2. Form fillet (75mm × 75mm) at all wall-floor junctions.
...
DO NOT: Apply waterproofing over wet substrate. Skip the fillet at junctions. Tile over waterproofing before full cure. Skip ponding test under any circumstances.`,
  ...
  {
    category: 'Civil & Masonry',
    title: 'Tile Laying - Floor',
    description: 'Lay floor tiles level, with consistent joint width, full bedding, and clean grouting.',
    content: `PURPOSE: Lay floor tiles level, with consistent joint width, full bedding, and clean grouting.
...
3. Apply adhesive to substrate with notched trowel. Apply adhesive to back of tile ("back-buttering") for tiles 600×600 and larger.
...
DO NOT: Lay tiles over uncured screed. Skip back-buttering on large-format tiles. Skip the layout marking — never start from a wall. Walk on tiles before 24-hour adhesive cure. Grout before 24-hour adhesive set.`,
  ...
  {
    category: 'Civil & Masonry',
    title: 'Marble & Stone Installation',
    description: 'Install marble or natural stone with full bedding, no staining, and a polished finish.',
    content: `PURPOSE: Install marble or natural stone with full bedding, no staining, and a polished finish.
...
DO NOT: Use ferrous (rust-prone) materials near stone before sealing — they will stain. Drag stones across each other. Skip sealer on porous stones (marble, limestone). Apply polish before bedding is fully cured (48 hours minimum).`,
  ...
  {
    category: 'Electrical',
    title: 'Concealed Wiring Installation',
    description: 'Install concealed electrical wiring safely, with proper conduit, junction box placement, and earthing.',
    content: `PURPOSE: Install concealed electrical wiring safely, with proper conduit, junction box placement, and earthing.
...
- Earthing wire: minimum 2.5mm² for sockets, 4mm² for high-load circuits
...
DO NOT: Use conduit smaller than specified (causes pulling damage). Join wires inside conduit. Mix earth and neutral. Run circuits without independent earthing. Close chases before testing.`,
  },
  {
    ...
    description: 'Install switches and sockets at standard heights, aligned, and tested.',
    content: `PURPOSE: Install switches and sockets at standard heights, aligned, and tested.
...
DO NOT: Tighten over-tight (can damage terminals). Leave loose strands of wire. Mix switch brands within a room. Install before walls are dry and clean.`,
  },
  {
    ...
    title: 'CPVC & UPVC Pipe Installation',
    description: 'Install water supply piping with proper joints, supports, and pressure testing.',
    content: `PURPOSE: Install water supply piping with proper joints, supports, and pressure testing.
...
9. Pressure test before concealment: 1.5× working pressure for minimum 1 hour. No drop acceptable.
...
DO NOT: Mix pipe brands or solvent brands. Apply cement to wet pipe. Move joint before set time. Conceal pipes before pressure test passes. Use hacksaw for cutting.`,
  },
  {
    ...
    description: 'Install sanitary fixtures level, sealed, and leak-tested.',
    content: `PURPOSE: Install sanitary fixtures level, sealed, and leak-tested.
...
DO NOT: Over-tighten fixings — cracks the porcelain. Use plumber's putty on chrome (causes pitting). Skip leak test. Use sealant as a substitute for proper mechanical seal.`,
  },
  {
    ...
    description: 'Install split AC indoor units securely, with proper drainage and refrigerant pipe routing.',
    content: `PURPOSE: Install split AC indoor units securely, with proper drainage and refrigerant pipe routing.
...
DO NOT: Install with reverse drainage slope. Kink refrigerant pipes. Skip wall sleeve. Use indoor electrical extension cord (must be permanent point).`,
  },
  {
    ...
    title: 'Aluminium Window & Door Installation',
    description: 'Install aluminium frames square, weather-sealed, and properly anchored.',
    content: `PURPOSE: Install aluminium frames square, weather-sealed, and properly anchored.
...
DO NOT: Force frame into out-of-square opening. Skip packers. Apply sealant to dirty surfaces. Use silicone where the manufacturer specifies a different sealant.`,
  },
  {
    ...
    description: 'Install toughened glass safely, with proper edge protection and secure fixing.',
    content: `PURPOSE: Install toughened glass safely, with proper edge protection and secure fixing.
...
DO NOT: Attempt to cut or drill toughened glass — it will shatter. Hold glass without edge protection. Allow glass-to-metal contact. Over-tighten clamps.`,
  },
  {
    ...
    title: 'Curtain & Drape Installation',
    description: 'Install curtain tracks/rods and drapes with proper drop, stack, and movement.',
    content: `PURPOSE: Install curtain tracks/rods and drapes with proper drop, stack, and movement.
...
DO NOT: Mount brackets only into drywall without anchors — must hit framing or use cavity anchors rated for load. Hem drapes before they have settled. Mix bracket types within a window.`,
  ...
  {
    category: 'Soft Furnishings',
    title: 'Sofa Upholstery Standards',
    description: 'Ensure delivered upholstery meets quality, comfort, and durability standards.',
    content: `PURPOSE: Ensure delivered upholstery meets quality, comfort, and durability standards.
...
- Inner cushions: feather/down blend or polyester fiber per spec
...
DO NOT: Use softwood or low-grade plywood for frame. Use low-density foam (under 28 density) — it will collapse. Skip pattern matching. Use staples where stitching is specified.`,
  },
  {
    ...
    title: 'Site Cleanliness & Safety',
    description: 'Maintain a clean, safe site that supports good workmanship and protects existing finishes.',
    content: `PURPOSE: Maintain a clean, safe site that supports good workmanship and protects existing finishes.
...
- Safety signage and PPE per OSHA/local standards
...
DO NOT: Allow eating or smoking on site. Permit workers without PPE. Skip daily cleanup. Use power tools without confirming circuit protection. Leave site without locking and securing.`,
  ...
  {
    category: 'Studio Operations',
    title: 'Drawing Issue & Revision Control',
    description: 'Ensure vendors and site teams always work from the current approved drawing — never an outdated version.',
    content: `PURPOSE: Ensure vendors and site teams always work from the current approved drawing — never an outdated version.
...
5. When new revision issued, send to all relevant parties (vendors, site team) with email confirming "Revision X supersedes Revision (X-1) — please destroy prior version."
...
8. No work proceeds on a drawing older than what's in the latest register.
...
DO NOT: Issue drawings without revision number and date. Make undocumented hand-changes to a drawing on site. Send unapproved drawings to vendors. Skip notifying all parties when a revision is issued.`,
  },
  {
    ...
    description: 'Close out a project formally with all documentation, snags closed, and warranties handed to the client.',
    content: `PURPOSE: Close out a project formally with all documentation, snags closed, and warranties handed to the client.
...
DO NOT: Hand over with open snags. Skip vendor warranty collection. Leave the site without client sign-off. Promise post-handover work that hasn't been specifically agreed.`,
  },
];
...
async function run() {
  ...
  try {
    // Check existing
    const existing = await client.query(`SELECT title FROM sops`);
    const existingTitles = new Set(existing.rows.map((r: any) => r.title));
    console.log(`Existing SOPs: ${existingTitles.size}`);

    let inserted = 0;
    let skipped = 0;
    for (const sop of SOPS) {
      if (existingTitles.has(sop.title)) {
        console.log(`  SKIP: ${sop.title}`);
        skipped++;
        continue;
      }
      await client.query(
        `INSERT INTO sops (title, category, description, content, created_by, org_id)
         VALUES ($1, $2, $3, $4, $5, $6)`,
        [sop.title, sop.category, sop.description, sop.content, USER_ID, ORG_ID]
      );
      console.log(`  INSERT: ${sop.title}`);
      inserted++;
    }

    const final = await client.query(`SELECT COUNT(*) FROM sops`);
    console.log(`\nDone. Inserted: ${inserted}, Skipped: ${skipped}, Total now: ${final.rows[0].count}`);
  } finally {
    client.release();
    await pool.end();
  }
